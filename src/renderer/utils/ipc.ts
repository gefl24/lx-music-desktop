...
// For web version, we'll define these types locally
type ProgressInfo = {
  percent: number
  transferred: number
  total: number
...
const WIN_MAIN_RENDERER_EVENT_NAME = {
  inited: 'win_main_inited',
  get_other_source: 'win_main_get_other_source',
  save_other_source: 'win_main_save_other_source',
  clear_other_source: 'win_main_clear_other_source',
  get_other_source_count: 'win_main_get_other_source_count',
  update_check: 'win_main_update_check',
  update_download_update: 'win_main_update_download_update',
  quit_update: 'win_main_quit_update',
  update_available: 'win_main_update_available',
  update_error: 'win_main_update_error',
  update_progress: 'win_main_update_progress',
  update_downloaded: 'win_main_update_downloaded',
  update_not_available: 'win_main_update_not_available',
  import_user_api: 'win_main_import_user_api',
  set_user_api: 'win_main_set_user_api',
  remove_user_api: 'win_main_remove_user_api',
  user_api_show_update_alert: 'win_main_user_api_show_update_alert',
  user_api_set_allow_update_alert: 'win_main_user_api_set_allow_update_alert',
  user_api_status: 'win_main_user_api_status',
  get_user_api_list: 'win_main_get_user_api_list',
  request_user_api: 'win_main_request_user_api',
  request_user_api_cancel: 'win_main_request_user_api_cancel',
  ...
  get_system_fonts: 'win_main_get_system_fonts',
  get_sound_effect_eq_preset: 'win_main_get_sound_effect_eq_preset',
  save_sound_effect_eq_preset: 'win_main_save_sound_effect_eq_preset',
  get_sound_effect_convolution_preset: 'win_main_get_sound_effect_convolution_preset',
  save_sound_effect_convolution_preset: 'win_main_save_sound_effect_convolution_preset',
  save_theme: 'win_main_save_theme',
  remove_theme: 'win_main_remove_theme',
  get_themes: 'win_main_get_themes',
  get_music_url: 'win_main_get_music_url',
  save_music_url: 'win_main_save_music_url',
  clear_music_url: 'win_main_clear_music_url',
  get_music_url_count: 'win_main_get_music_url_count',
  get_palyer_lyric: 'win_main_get_palyer_lyric',
  get_lyric_raw: 'win_main_get_lyric_raw',
  clear_lyric_raw: 'win_main_clear_lyric_raw',
  get_lyric_raw_count: 'win_main_get_lyric_raw_count',
  get_lyric_edited: 'win_main_get_lyric_edited',
  save_lyric_raw: 'win_main_save_lyric_raw',
  save_lyric_edited: 'win_main_save_lyric_edited',
  remove_lyric_edited: 'win_main_remove_lyric_edited',
  clear_lyric: 'win_main_clear_lyric',
  clear_lyric_edited: 'win_main_clear_lyric_edited',
  get_lyric_edited_count: 'win_main_get_lyric_edited_count',
  show_select_dialog: 'win_main_show_select_dialog',
  show_save_dialog: 'win_main_show_save_dialog',
  open_dir_in_explorer: 'win_main_open_dir_in_explorer',
  get_cache_size: 'win_main_get_cache_size',
  clear_cache: 'win_main_clear_cache',
  set_window_size: 'win_main_set_window_size',
  fullscreen: 'win_main_fullscreen',
  open_dev_tools: 'win_main_open_dev_tools',
  sync_action: 'win_main_sync_action',
  sync_get_server_devices: 'win_main_sync_get_server_devices',
  sync_remove_server_device: 'win_main_sync_remove_server_device',
  download_list_get: 'win_main_download_list_get',
  download_list_add: 'win_main_download_list_add',
  download_list_update: 'win_main_download_list_update',
  download_list_remove: 'win_main_download_list_remove',
  download_list_clear: 'win_main_download_list_clear',
  on_config_change: 'win_main_on_config_change',
  quit: 'win_main_quit',
  close: 'win_main_close',
  min: 'win_main_min',
  min_toggle: 'win_main_min_toggle',
  hide_toggle: 'win_main_hide_toggle',
  focus: 'win_main_focus',
  set_power_save_blocker: 'win_main_set_power_save_blocker',
  key_down: 'win_main_key_down',
  set_hot_key_config: 'win_main_set_hot_key_config',
}

const CMMON_EVENT_NAME = {
